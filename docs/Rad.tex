...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assets/arhitektura.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assets/certificates.png}
...
Nadalje, napravit će se jednostavan HTTPS poslužitelj kojem će se prikazati način provjere valjanosti digitalnog ceritfikata u web pregledniku.
