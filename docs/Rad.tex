...
\textbf{Autentifikacija}

Administrator se mora autentificirati kako bi mogao koristiti sustav.
...
\textbf{Generiranje zahtjeva za potpisivanje certifikata}
...
\textbf{Implementacija HTTPS poslužitelja}
